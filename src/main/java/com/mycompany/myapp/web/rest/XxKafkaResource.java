...
@RestController
@RequestMapping("/api/xx-kafka")
public class XxKafkaResource {
    private final Logger log = LoggerFactory.getLogger(XxKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public XxKafkaResource(KafkaProperties kafkaProperties) {
